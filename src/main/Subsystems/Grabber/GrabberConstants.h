...
public:
    ...
    inline static const std::map<Positions, units::volt_t> GrabberVoltage = { {Positions::AlgaeGround, 10.0_V}, {
            Positions::AlgaeHold, 4_V}, {Positions::AlgaeHighReef, 10.0_V}, {Positions::AlgaeLowReef, 10.0_V}, {
            ...
            Positions::L4FrontConfirm, 0.0_V}, {Positions::NetPosition, 4_V}, {Positions::NetConfirm, -11.0_V}, {
    ...
    constexpr static const units::volt_t GrabberSpitAlgae = -4_V;
    ...
    constexpr static const OverTalonFXConfig GrabberConfig() {
        ...
        grabberConfig.StatorCurrentLimit = 80_A;
