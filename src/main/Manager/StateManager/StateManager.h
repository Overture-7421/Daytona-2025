...
public:
    ...
    frc2::CommandPtr InitialToSustained() { // Done
        return frc2::cmd::Sequence(intake->setState(Positions::InitialPosition),
                ...
                climber->servoAngleCommand(ClimberConstants::ClosedServo)).AlongWith(
    ...
    frc2::CommandPtr SustainedToIntake() { // Done
        ...
        }).AlongWith(setStatePosition(Positions::Intake));
    }
    ...
    frc2::CommandPtr SustainedToAlgaeLowReef() { // Done
        return frc2::cmd::Sequence(elevator->setState(Positions::AlgaeLowReef), arm->setState(Positions::AlgaeLowReef),
                ...
                climber->setState(Positions::AlgaeLowReef)).AlongWith(setStatePosition(Positions::AlgaeLowReef)).OnlyIf(
                [this] {
                    return !grabber->isCoralIn() && !intake->isCoralIn();
                });
    }
    ...
    frc2::CommandPtr SustainedToAlgaeHighReef() { // Done
        return frc2::cmd::Sequence(elevator->setState(Positions::AlgaeHighReef),
                ...
                intake->setState(Positions::AlgaeHighReef), climber->setState(Positions::AlgaeHighReef)).AlongWith(
    ...
    frc2::CommandPtr SustainedToAlgaeGround() { // Done
        return frc2::cmd::Sequence(intake->setState(Positions::AlgaeGround), arm->setState(Positions::AlgaeGround),
                ...
                climber->setState(Positions::AlgaeGround)).AlongWith(setStatePosition(Positions::AlgaeGround)).OnlyIf(
                [this] {
                    return !grabber->isCoralIn() && !intake->isCoralIn();
                });
    }
    ...
    frc2::CommandPtr SustainedToEndPosition() { // Done
        return frc2::cmd::Sequence(intake->setState(Positions::EndPosition), arm->setState(Positions::EndPosition),
                ...
                climber->setState(Positions::EndPosition)).AlongWith(setStatePosition(Positions::EndPosition));
    }
    ...
    frc2::CommandPtr IntakeToSustained() { // Done
        return frc2::cmd::Sequence(elevator->setState(Positions::SustainedPosition),
                ...
                grabber->setState(Positions::SustainedPosition), climber->setState(Positions::SustainedPosition)).AlongWith(
    ...
    frc2::CommandPtr IntakeToL1Position() { // Done
        return frc2::cmd::Parallel(
                ...
                intake->setState(Positions::L1Position)).AlongWith(setStatePosition(Positions::L1Position)).OnlyIf(
                [this] {
                    return intake->isCoralIn() && !grabber->isCoralIn();
                });
    }
    ...
    frc2::CommandPtr AlgaeHighReefToAlgaeHold() { // Done
        return frc2::cmd::Sequence(arm->setState(Positions::AlgaeHold), elevator->setState(Positions::AlgaeHold),
                ...
                climber->setState(Positions::AlgaeHold)).AlongWith(setStatePosition(Positions::AlgaeHold)).OnlyIf(
                [this] {
                    return grabber->isAlgaeIn() && !intake->isCoralIn();
                });
    }
    ...
    frc2::CommandPtr L1PositionToL1Confirm() { // Done
        return frc2::cmd::Parallel(elevator->setState(Positions::L1Confirm), arm->setState(Positions::L1Confirm),
                ...
                climber->setState(Positions::L1Confirm)).AlongWith(setStatePosition(Positions::L1Confirm));
    }
    ...
    frc2::CommandPtr L1PositionToCoralHold() { // Done
        return frc2::cmd::Sequence(arm->setState(Positions::CoralHold), elevator->setState(Positions::CoralHold),
                ...
                climber->setState(Positions::CoralHold)).AlongWith(setStatePosition(Positions::CoralHold)).OnlyIf(
                [this] {
                    return !grabber->isAlgaeIn() && intake->isCoralIn();
                });
    }
    ...
    frc2::CommandPtr CoralHoldToL1Position() { // Done
        return frc2::cmd::Parallel(
                ...
                climber->setState(Positions::L1Position)).AlongWith(setStatePosition(Positions::L1Position)).OnlyIf(
                [this] {
    ...
    frc2::CommandPtr CoralHoldToL2Front() { // Done
        return frc2::cmd::Parallel(
                ...
                grabber->setState(Positions::L2Front), climber->setState(Positions::L2Front)).AlongWith(
                setStatePosition(Positions::L2Front)).OnlyIf([this] {
            return grabber->isCoralIn();
        });
    }
    ...
    frc2::CommandPtr CoralHoldToL3Front() { // Done
        return frc2::cmd::Parallel(arm->setState(Positions::L3Front, Heading::Front),
                ...
                grabber->setState(Positions::L3Front), climber->setState(Positions::L3Front)).AlongWith(
                setStatePosition(Positions::L3Front)).OnlyIf([this] {
            return grabber->isCoralIn();
        });
    }
    ...
    frc2::CommandPtr CoralHoldToL4Front() {  // Done
        return frc2::cmd::Parallel(arm->setState(Positions::L4Front, Heading::Front),
                elevator->setState(Positions::L4Front), intake->setState(Positions::L4Front),
                grabber->setState(Positions::L4Front), climber->setState(Positions::L4Front)).AlongWith(
                setStatePosition(Positions::L4Front)).OnlyIf([this] {
            return grabber->isCoralIn();
        });
    }
    ...
    frc2::CommandPtr CoralHoldToL2Back() { // Done
        return frc2::cmd::Parallel(
                ...
                grabber->setState(Positions::L2Back), climber->setState(Positions::L2Back)).AlongWith(
                setStatePosition(Positions::L2Back)).OnlyIf([this] {
            return grabber->isCoralIn();
        });
    }
    ...
    frc2::CommandPtr CoralHoldToL3Back() {  // Done
        return frc2::cmd::Parallel(arm->setState(Positions::L3Back, Heading::Back),
                ...
                grabber->setState(Positions::L3Back), climber->setState(Positions::L3Back)).AlongWith(
                setStatePosition(Positions::L3Back)).OnlyIf([this] {
            return grabber->isCoralIn();
        });
    }
    ...
    frc2::CommandPtr CoralHoldToL4Back() { // Done
        return frc2::cmd::Parallel(arm->setState(Positions::L4Back, Heading::Back),
                elevator->setState(Positions::L4Back), intake->setState(Positions::L4Back),
                grabber->setState(Positions::L4Back), climber->setState(Positions::L4Back)).AlongWith(
                setStatePosition(Positions::L4Back)).OnlyIf([this] {
            return grabber->isCoralIn();
        });
    }
    ...
    frc2::CommandPtr AlgaeHoldToNet() { // Done
        return frc2::cmd::Sequence(arm->setState(Positions::NetPosition), elevator->setState(Positions::NetPosition),
                ...
                climber->setState(Positions::NetPosition)).AlongWith(setStatePosition(Positions::NetPosition)).OnlyIf(
                [this] {
                    return grabber->isAlgaeIn();
                });
    }
    ...
    frc2::CommandPtr AlgaeHoldToProcessor() { // Done
        return frc2::cmd::Sequence(intake->setState(Positions::ProcessorPosition),
                ...
                grabber->setState(Positions::ProcessorPosition), climber->setState(Positions::ProcessorPosition)).AlongWith(
    ...
    frc2::CommandPtr L2FrontToFrontConfirm() { // Done
        return frc2::cmd::Parallel(arm->setState(Positions::L2FrontConfirm, Heading::Front),
                ...
                grabber->setState(Positions::L2FrontConfirm), climber->setState(Positions::L2FrontConfirm)).AlongWith(
                setStatePosition(Positions::L2FrontConfirm)).OnlyIf([this] {
            return grabber->isCoralIn();
        });
    }
    ...
    frc2::CommandPtr L3FrontToFrontConfirm() {  // Done
        return frc2::cmd::Parallel(arm->setState(Positions::L3FrontConfirm, Heading::Front),
                ...
                grabber->setState(Positions::L3FrontConfirm), climber->setState(Positions::L3FrontConfirm)).AlongWith(
                setStatePosition(Positions::L3FrontConfirm)).OnlyIf([this] {
            return grabber->isCoralIn();
        });
    }
    ...
    frc2::CommandPtr L4FrontToFrontConfirm() { // Done
        return frc2::cmd::Parallel(arm->setState(Positions::L4FrontConfirm, Heading::Front),
                ...
                grabber->setState(Positions::L4FrontConfirm), climber->setState(Positions::L4FrontConfirm)).AlongWith(
                setStatePosition(Positions::L4FrontConfirm)).OnlyIf([this] {
            return grabber->isCoralIn();
        });
    }
    ...
    frc2::CommandPtr L2BackToBackConfirm() { // Done
        return frc2::cmd::Parallel(arm->setState(Positions::L2BackConfirm, Heading::Back),
                ...
                grabber->setState(Positions::L2BackConfirm), climber->setState(Positions::L2BackConfirm)).AlongWith(
                setStatePosition(Positions::L2BackConfirm)).OnlyIf([this] {
            return grabber->isCoralIn();
        });
    }
    ...
    frc2::CommandPtr L3BackToBackConfirm() { // Done
        return frc2::cmd::Parallel(arm->setState(Positions::L3BackConfirm, Heading::Back),
                ...
                grabber->setState(Positions::L3BackConfirm), climber->setState(Positions::L3BackConfirm)).AlongWith(
                setStatePosition(Positions::L3BackConfirm)).OnlyIf([this] {
            return grabber->isCoralIn();
        });
    }
    ...
    frc2::CommandPtr L4BackToBackConfirm() { // Done
        return frc2::cmd::Parallel(arm->setState(Positions::L4BackConfirm, Heading::Back),
                ...
                grabber->setState(Positions::L4BackConfirm), climber->setState(Positions::L4BackConfirm)).AlongWith(
                setStatePosition(Positions::L4BackConfirm)).OnlyIf([this] {
            return grabber->isCoralIn();
        });
    }
    ...
    frc2::CommandPtr NetPositionToNetConfirm() { // Done
        return frc2::cmd::Sequence(grabber->setState(Positions::NetConfirm), arm->setState(Positions::NetConfirm),
                ...
                climber->setState(Positions::NetConfirm)).AlongWith(setStatePosition(Positions::NetConfirm)).OnlyIf(
                [this] {
                    return grabber->isAlgaeIn();
                });
    }
    ...
    frc2::CommandPtr ProcessorPositionToProcessorConfirm() { // Done
        return frc2::cmd::Sequence(grabber->setState(Positions::ProcessorConfirm),
                ...
                elevator->setState(Positions::ProcessorConfirm), climber->setState(Positions::ProcessorConfirm)).AlongWith(
