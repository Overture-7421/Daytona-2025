...
private:
	...
	frc2::CommandPtr InitialToSustained = frc2::cmd::Sequence(intake->setState(Positions::InitialPosition),
	...
	frc2::CommandPtr InitialToL4Front = frc2::cmd::Parallel(arm->setState(Positions::L4Front, Heading::Front),
	...
	frc2::CommandPtr InitialToL4Back = frc2::cmd::Parallel(arm->setState(Positions::L4Back, Heading::Back),
	...
	frc2::CommandPtr SustainedToIntake = frc2::cmd::Sequence(intake->setState(Positions::Intake),
		elevator->setState(Positions::Intake), arm->setState(Positions::Intake), grabber->setState(Positions::Intake),
		climber->setState(Positions::Intake));


	frc2::CommandPtr SustainedToAlgaeLowReef = frc2::cmd::Sequence(elevator->setState(Positions::AlgaeLowReef), arm->setState(Positions::AlgaeLowReef),
		grabber->setState(Positions::AlgaeLowReef), intake->setState(Positions::AlgaeLowReef),
		climber->setState(Positions::AlgaeLowReef));


	frc2::CommandPtr SustainedToAlgaeHighReef = frc2::cmd::Sequence(elevator->setState(Positions::AlgaeHighReef),
 ...
 { Positions::L1Position, Positions::L1Confirm, [this]() {
	 ...
	 return frc2::cmd::Sequence(arm->setState(Positions::CoralHold),
			 elevator->setState(Positions::CoralHold), intake->setState(Positions::CoralHold), grabber->setState(Positions::CoralHold),
