...
public:
	...
	inline static const std::map<Positions, units::volt_t> GrabberVoltage = { {Positions::AlgaeGround, 8.0_V}, {
			...
			Positions::L4FrontConfirm, 0.0_V}, {Positions::NetPosition, 0.75_V}, {Positions::NetConfirm, -11.0_V}, {
	...
	constexpr static const double AlgaeDetectionCurrent = 50.0; //To be defined
