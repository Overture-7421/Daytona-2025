...
private:
    ...
    frc::TrapezoidProfile<units::meters>::Constraints defaultConstraints {3.0_mps, 1.0_mps_sq};

    frc::TrapezoidProfile<units::meters>::Constraints minimumConstraints {1.0_mps, defaultConstraints.maxAcceleration};
