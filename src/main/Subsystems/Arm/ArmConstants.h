...
struct ArmConstants {
	...
	inline static const std::map<Positions, units::degree_t> ArmFront{ {Positions::InitialPosition, -90_deg}, {
			...
			30.0_deg}, {Positions::L1Position, 90_deg}, {Positions::L1Confirm, 90.0_deg},
			...
			{Positions::L2Front, -54.0_deg}, {Positions::L3Front, 307.0_deg}, {Positions::L4Front, 303.0_deg}, {
					...
					Positions::L4FrontConfirm, 342.0_deg}, {Positions::NetPosition, -120.0_deg}, {Positions::NetConfirm,
					-80.0_deg}, {Positions::ProcessorPosition, 0.0_deg}, {Positions::ProcessorConfirm, 0.0_deg}, {
