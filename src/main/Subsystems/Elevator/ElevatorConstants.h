...
struct ElevatorConstants {
    ...
    inline static const std::map<Positions, units::meter_t> ElevatorPositions = { {Positions::AlgaeGround, 0.01_m}, {
            Positions::AlgaeHold, 0.97_m}, {Positions::AlgaeHighReef, 1.28_m}, {Positions::AlgaeLowReef, 0.68_m}, {
            Positions::CoralAndAlgae, 1.05_m}, {Positions::CoralHold, 0.95_m}, {Positions::InitialPosition, 0.00_m}, {
            ...
            Positions::L4FrontConfirm, 1.60_m}, {Positions::NetPosition, 1.69_m}, {Positions::NetConfirm, 1.69_m}, {
