...
frc2::CommandPtr StateManager::SustainedToIntake() {
	return frc2::cmd::Sequence(climber->setClimberCommand(ClimberConstants::ClimberRest),
		...
		arm->setState(Positions::Intake), grabber->setState(Positions::Intake)).AlongWith(setStatePosition(Positions::Intake));
}
...
frc2::CommandPtr StateManager::CoralHoldToL1Position() {
	return (frc2::cmd::Sequence(arm->setState(Positions::L1Position), elevator->setState(Positions::CoralHold),
		intake->setState(Positions::SustainToL1), grabber->setState(Positions::CoralSpit), elevator->setState(Positions::L1Position), frc2::cmd::Wait(0.2_s), intake->setState(Positions::L1Position)).AlongWith(
			setStatePosition(Positions::L1Position)));
}
...
frc2::CommandPtr StateManager::AlgaeHoldToProcessor() {
	return (frc2::cmd::Sequence(intake->setState(Positions::ProcessorPosition),
		...
		grabber->setState(Positions::ProcessorPosition)).AlongWith(
			setStatePosition(Positions::ProcessorPosition)));
}
...
frc2::CommandPtr StateManager::ProcessorPositionToProcessorConfirm() {
	return (frc2::cmd::Sequence(grabber->setState(Positions::ProcessorConfirm),
		...
		elevator->setState(Positions::ProcessorConfirm)).AlongWith(
			setStatePosition(Positions::ProcessorConfirm)));
}
