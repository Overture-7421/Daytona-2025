...
private:
    ...
    std::map<Positions, const frc2::CommandPtr&> positionsMap { {Positions::L1Position, frc2::cmd::Parallel(
    ...
    {Positions::L2Front, frc2::cmd::Parallel(
            frc2::cmd::Sequence(arm->setState(Positions::L2Front),
    ...
    {Positions::L2FrontConfirm, frc2::cmd::Parallel(arm->setState(Positions::L2FrontConfirm),
            elevator->setState(Positions::L2FrontConfirm, Heading::Front)), intake->setState(Positions::L2FrontConfirm),
            grabber->setState(Positions::L2FrontConfirm), climber->setState(Positions::L2FrontConfirm)},

    {Positions::L2Back, frc2::cmd::Parallel(
            frc2::cmd::Sequence(arm->setState(Positions::L2Back), elevator->setState(Positions::L2Back, Heading::Back)),
            frc2::cmd::Parallel(intake->setState(Positions::L2Back), grabber->setState(Positions::L2Back),
                    climber->setState(Positions::L2Back)))},

    {Positions::L2BackConfirm, frc2::cmd::Parallel(arm->setState(Positions::L2BackConfirm),
            elevator->setState(Positions::L2BackConfirm, Heading::Back)), intake->setState(Positions::L2BackConfirm),
            grabber->setState(Positions::L2BackConfirm), climber->setState(Positions::L2BackConfirm)},

    {Positions::L3Front, frc2::cmd::Parallel(arm->setState(Positions::L3Front),
            elevator->setState(Positions::L3Front, Heading::Front)), intake->setState(Positions::L3Front),
            grabber->setState(Positions::L3Front), climber->setState(Positions::L3Front)},

    {Positions::L3FrontConfirm, frc2::cmd::Parallel(arm->setState(Positions::L3FrontConfirm),
            elevator->setState(Positions::L3FrontConfirm, Heading::Front)), intake->setState(Positions::L3FrontConfirm),
            grabber->setState(Positions::L3FrontConfirm), climber->setState(Positions::L3FrontConfirm)},

    {Positions::L3Back, frc2::cmd::Parallel(arm->setState(Positions::L3Back),
            elevator->setState(Positions::L3Back, Heading::Back)), intake->setState(Positions::L3Back),
            grabber->setState(Positions::L3Back), climber->setState(Positions::L3Back)},

    {Positions::L3BackConfirm, frc2::cmd::Parallel(arm->setState(Positions::L3BackConfirm),
            elevator->setState(Positions::L3BackConfirm, Heading::Back)), intake->setState(Positions::L3BackConfirm),
            grabber->setState(Positions::L3BackConfirm), climber->setState(Positions::L3BackConfirm)},

    {Positions::L4Front, frc2::cmd::Parallel(arm->setState(Positions::L4Front),
            elevator->setState(Positions::L4Front, Heading::Front)), intake->setState(Positions::L4Front),
            grabber->setState(Positions::L4Front), climber->setState(Positions::L4Front)},

    {Positions::L4FrontConfirm, frc2::cmd::Parallel(arm->setState(Positions::L4FrontConfirm),
            elevator->setState(Positions::L4FrontConfirm, Heading::Front)), intake->setState(Positions::L4FrontConfirm),
            grabber->setState(Positions::L4FrontConfirm), climber->setState(Positions::L4FrontConfirm)},

    {Positions::L4Back, frc2::cmd::Parallel(arm->setState(Positions::L4Back),
            elevator->setState(Positions::L4Back, Heading::Back)), intake->setState(Positions::L4Back),
            grabber->setState(Positions::L4Back), climber->setState(Positions::L4Back)},

    {Positions::L4BackConfirm, frc2::cmd::Parallel(arm->setState(Positions::L4BackConfirm),
            elevator->setState(Positions::L4BackConfirm, Heading::Back)), intake->setState(Positions::L4BackConfirm),
