...
private:
    ...
    std::vector<Transitions> transitionsMap =
                ...
                return frc::DriverStation::IsEnabled();
            }, frc2::cmd::Sequence(elevator->setState(Positions::SustainedPosition),
                    ...
                    {Positions::InitialPosition, Positions::L2Front, [this]() {
                        return frc::DriverStation::IsAutonomous() && grabber->isCoralIn();
                            ...
                            frc2::cmd::Parallel(intake->setState(Positions::L2Front),
                                    grabber->setState(Positions::L2Front), climber->setState(Positions::L2Front)))}, {
                            Positions::InitialPosition, Positions::L3Front, [this]() {
                                return frc::DriverStation::IsAutonomous() && grabber->isCoralIn();
                            }, frc2::cmd::Parallel(arm->setState(Positions::L3Front, Heading::Front),
                    ...
                    {Positions::InitialPosition, Positions::L2Back, [this]() {
                        return frc::DriverStation::IsAutonomous() && grabber->isCoralIn();
                            ...
                            frc2::cmd::Sequence(arm->setState(Positions::L2Back, Heading::Back),
                                    elevator->setState(Positions::L2Back)),
                            frc2::cmd::Parallel(intake->setState(Positions::L2Back),
                                    grabber->setState(Positions::L2Back), climber->setState(Positions::L2Back)))}, {
                            Positions::InitialPosition, Positions::L3Back, [this]() {
                                return frc::DriverStation::IsAutonomous() && grabber->isCoralIn();
                            }, frc2::cmd::Parallel(arm->setState(Positions::L3Back, Heading::Back),
                            ...
                            Positions::InitialPosition, Positions::L4Back, [this]() {
                                return frc::DriverStation::IsAutonomous() && grabber->isCoralIn();
                            }, frc2::cmd::Parallel(arm->setState(Positions::L4Back, Heading::Back),
                    ...
                    }, frc2::cmd::Sequence(intake->setState(Positions::Intake), elevator->setState(Positions::Intake),
                            arm->setState(Positions::Intake), grabber->setState(Positions::Intake),
                            climber->setState(Positions::Intake))}, {Positions::SustainedPosition,
                            Positions::IntakeCoralStation, [this]() {
                                return !grabber->isCoralIn() && !intake->isCoralIn();
                            }, frc2::cmd::Sequence(intake->setState(Positions::IntakeCoralStation),
                                    elevator->setState(Positions::IntakeCoralStation),
                                    arm->setState(Positions::IntakeCoralStation),
                                    grabber->setState(Positions::IntakeCoralStation),
                                    climber->setState(Positions::IntakeCoralStation))}, {Positions::SustainedPosition,
                            Positions::AlgaeLowReef, [this]() {
                                return !grabber->isCoralIn() && !intake->isCoralIn()
                                        && (alignManager->getAlgaePose() == AlgaePose::Down);
                            }, frc2::cmd::Sequence(elevator->setState(Positions::AlgaeLowReef),
                                    arm->setState(Positions::AlgaeLowReef), grabber->setState(Positions::AlgaeLowReef),
                                    intake->setState(Positions::AlgaeLowReef),
                                    climber->setState(Positions::AlgaeLowReef))}, {Positions::SustainedPosition,
                            Positions::AlgaeHighReef, [this]() {
                                return !grabber->isCoralIn() && !intake->isCoralIn()
                                        && (alignManager->getAlgaePose() == AlgaePose::Up);
                            }, frc2::cmd::Sequence(elevator->setState(Positions::AlgaeHighReef),
                                    arm->setState(Positions::AlgaeHighReef),
                                    grabber->setState(Positions::AlgaeHighReef),
                                    intake->setState(Positions::AlgaeHighReef),
                                    climber->setState(Positions::AlgaeHighReef))}, {Positions::SustainedPosition,
                            Positions::AlgaeGround, [this]() {
                                return !grabber->isCoralIn() && !intake->isCoralIn();
                            }, frc2::cmd::Sequence(intake->setState(Positions::AlgaeGround),
                                    arm->setState(Positions::AlgaeGround), elevator->setState(Positions::AlgaeGround),
                                    grabber->setState(Positions::AlgaeGround),
                                    climber->setState(Positions::AlgaeGround))}, {Positions::SustainedPosition,
                        ...
                        return !driver->LeftTrigger().Get() && !intake->isCoralIn() && !grabber->isCoralIn();
                            ...
                            Positions::L1Position, [this]() {
                                return intake->isCoralIn() && driver->LeftTrigger().Get();
                                    ...
                                    frc2::cmd::Parallel(intake->setState(Positions::L1Position),
                                            grabber->setState(Positions::L1Position),
                                            climber->setState(Positions::L1Position)))}, {Positions::Intake,
                            Positions::CoralAndAlgae, [this]() {
                                return intake->isCoralIn() && grabber->isAlgaeIn();
                                    ...
                                    climber->setState(Positions::CoralAndAlgae))}, {Positions::Intake,
                            Positions::EndPosition, [this]() {
                                return console->Button(4).Get() || oprtr->Back().Get();
                            }, frc2::cmd::Sequence(arm->setState(Positions::EndPosition),
                                    elevator->setState(Positions::EndPosition),
                    ...
                    {Positions::IntakeCoralStation, Positions::SustainedPosition, [this]() {
                        return (!oprtr->RightBumper().Get() || !console->AxisMagnitudeGreaterThan(0, 0.1).Get())
                                && !intake->isCoralIn() && !grabber->isCoralIn();
                    }, frc2::cmd::Sequence(elevator->setState(Positions::SustainedPosition),
                            arm->setState(Positions::SustainedPosition), intake->setState(Positions::SustainedPosition),
                            grabber->setState(Positions::SustainedPosition),
                            ...
                            Positions::L1Position, [this]() {
                                return intake->isCoralIn() && driver->LeftTrigger().Get();
                                    ...
                                    frc2::cmd::Parallel(intake->setState(Positions::L1Position),
                                            grabber->setState(Positions::L1Position),
                                            climber->setState(Positions::L1Position)))}, {Positions::IntakeCoralStation,
                            Positions::CoralAndAlgae, [this]() {
                                return intake->isCoralIn() && grabber->isAlgaeIn();
                            }, frc2::cmd::Sequence(elevator->setState(Positions::CoralAndAlgae),
                                    arm->setState(Positions::CoralAndAlgae), intake->setState(Positions::CoralAndAlgae),
                                    grabber->setState(Positions::CoralAndAlgae),
                                    climber->setState(Positions::CoralAndAlgae))}, {Positions::IntakeCoralStation,
                            Positions::EndPosition, [this]() {
                                return console->Button(4).Get() || oprtr->Back().Get();
                            }, frc2::cmd::Sequence(arm->setState(Positions::EndPosition),
                                    elevator->setState(Positions::EndPosition),
                    ...
                    {Positions::AlgaeHighReef, Positions::SustainedPosition, [this]() {
                        return (!oprtr->POVUp().Get() || !console->Button(1).Get()) && !grabber->isAlgaeIn();
                            ...
                            arm->setState(Positions::SustainedPosition), intake->setState(Positions::SustainedPosition),
                            grabber->setState(Positions::SustainedPosition),
                            climber->setState(Positions::SustainedPosition))}, {Positions::AlgaeHighReef,
                            Positions::CoralAndAlgae, [this]() {
                                return intake->isCoralIn() && grabber->isAlgaeIn();
                            }, frc2::cmd::Sequence(elevator->setState(Positions::CoralAndAlgae),
                                    arm->setState(Positions::CoralAndAlgae), intake->setState(Positions::CoralAndAlgae),
                                    grabber->setState(Positions::CoralAndAlgae),
                                    climber->setState(Positions::CoralAndAlgae))}, {Positions::AlgaeHighReef,
                            Positions::AlgaeHold, [this]() {
                                return grabber->isAlgaeIn();
                            }, frc2::cmd::Sequence(arm->setState(Positions::AlgaeHold),
                                    elevator->setState(Positions::AlgaeHold), intake->setState(Positions::AlgaeHold),
                                    grabber->setState(Positions::AlgaeHold), climber->setState(Positions::AlgaeHold))},
                    ...
                    {Positions::AlgaeLowReef, Positions::SustainedPosition, [this]() {
                        return (!oprtr->POVDown().Get() || !console->Button(1).Get()) && !grabber->isAlgaeIn();
                            ...
                            arm->setState(Positions::SustainedPosition), intake->setState(Positions::SustainedPosition),
                            grabber->setState(Positions::SustainedPosition),
                            climber->setState(Positions::SustainedPosition))}, {Positions::AlgaeLowReef,
                            Positions::CoralAndAlgae, [this]() {
                                return intake->isCoralIn() && grabber->isAlgaeIn();
                            }, frc2::cmd::Sequence(elevator->setState(Positions::CoralAndAlgae),
                                    arm->setState(Positions::CoralAndAlgae), intake->setState(Positions::CoralAndAlgae),
                                    grabber->setState(Positions::CoralAndAlgae),
                                    climber->setState(Positions::CoralAndAlgae))}, {Positions::AlgaeLowReef,
                            Positions::AlgaeHold, [this]() {
                                return grabber->isAlgaeIn();
                            }, frc2::cmd::Sequence(arm->setState(Positions::AlgaeHold),
                                    elevator->setState(Positions::AlgaeHold), intake->setState(Positions::AlgaeHold),
                    ...
                    {Positions::AlgaeGround, Positions::SustainedPosition, [this]() {
                        return !driver->POVLeft().Get() && !grabber->isAlgaeIn();
                            ...
                            arm->setState(Positions::SustainedPosition), intake->setState(Positions::SustainedPosition),
                            grabber->setState(Positions::SustainedPosition),
                            climber->setState(Positions::SustainedPosition))}, {Positions::AlgaeGround,
                            Positions::CoralAndAlgae, [this]() {
                                return intake->isCoralIn() && grabber->isAlgaeIn();
                            }, frc2::cmd::Sequence(elevator->setState(Positions::CoralAndAlgae),
                                    arm->setState(Positions::CoralAndAlgae), intake->setState(Positions::CoralAndAlgae),
                                    grabber->setState(Positions::CoralAndAlgae),
                                    climber->setState(Positions::CoralAndAlgae))}, {Positions::AlgaeGround,
                            Positions::AlgaeHold, [this]() {
                                return grabber->isAlgaeIn();
                            }, frc2::cmd::Sequence(arm->setState(Positions::AlgaeHold),
                                    elevator->setState(Positions::AlgaeHold), intake->setState(Positions::AlgaeHold),
                    ...
                    {Positions::CoralHold, Positions::L1Position, [this]() {
                        return grabber->isCoralIn() && driver->POVUp().Get();
                            ...
                            frc2::cmd::Sequence(arm->setState(Positions::L1Position),
                                    elevator->setState(Positions::L1Position)),
                            frc2::cmd::Parallel(intake->setState(Positions::L1Position),
                                    grabber->setState(Positions::L1Position), climber->setState(Positions::L1Position)))},
                    {Positions::CoralHold, Positions::L2Front, [this]() {
                        return grabber->isCoralIn() && (alignManager->getHeading() == Heading::Front)
                            ...
                            , intake->setState(Positions::L4Front), grabber->setState(Positions::L4Front),
                                    climber->setState(Positions::L4Front))}, {Positions::CoralHold, Positions::L2Back, [
                            this]() {
                    ...
                    {Positions::CoralAndAlgae, Positions::CoralHold, [this]() {
                        return !grabber->isAlgaeIn();
                            ...
                            climber->setState(Positions::CoralHold))}, {Positions::CoralAndAlgae,
                            Positions::NetPosition, [this]() {
                                return grabber->isAlgaeIn() && driver->POVLeft().Get();
                            }, frc2::cmd::Sequence(arm->setState(Positions::NetPosition),
                                    elevator->setState(Positions::NetPosition),
                                    grabber->setState(Positions::NetPosition), intake->setState(Positions::NetPosition),
                                    climber->setState(Positions::NetPosition))}, {Positions::CoralAndAlgae,
                            Positions::ProcessorPosition, [this]() {
                                return grabber->isAlgaeIn() && (oprtr->LeftBumper().Get() || console->Button(9).Get());
                            }, frc2::cmd::Sequence(intake->setState(Positions::ProcessorPosition),
                                    arm->setState(Positions::ProcessorPosition),
                                    elevator->setState(Positions::ProcessorPosition),
                                    grabber->setState(Positions::ProcessorPosition),
                                    climber->setState(Positions::ProcessorPosition))}, {Positions::CoralAndAlgae,
                            Positions::EndPosition, [this]() {
                                return console->Button(4).Get() || oprtr->Back().Get();
                            }, frc2::cmd::Sequence(arm->setState(Positions::EndPosition),
                                    elevator->setState(Positions::EndPosition),
                    ...
                    {Positions::AlgaeHold, Positions::NetPosition, [this]() {
                        return grabber->isAlgaeIn() && driver->POVLeft().Get();
                            ...
                            elevator->setState(Positions::NetPosition), grabber->setState(Positions::NetPosition),
                            intake->setState(Positions::NetPosition), climber->setState(Positions::NetPosition))}, {
                            Positions::AlgaeHold, Positions::ProcessorPosition, [this]() {
                                return grabber->isAlgaeIn() && (oprtr->LeftBumper().Get() || console->Button(9).Get());
                                    ...
                                    elevator->setState(Positions::ProcessorPosition),
                                    grabber->setState(Positions::ProcessorPosition),
                                    climber->setState(Positions::ProcessorPosition))}, {Positions::AlgaeHold,
                            Positions::EndPosition, [this]() {
                                return console->Button(4).Get() || oprtr->Back().Get();
                            }, frc2::cmd::Sequence(arm->setState(Positions::EndPosition),
                                    elevator->setState(Positions::EndPosition),
                    ...
                    }, frc2::cmd::Parallel(arm->setState(Positions::L2FrontConfirm, Heading::Front),
                    ...
                    {Positions::L3Front, Positions::FrontConfirm, [this]() {
                        return grabber->isCoralIn() && driver->RightBumper().Get()
                                ...
                                && alignManager->getHeading() == Heading::Front;
                    }, frc2::cmd::Parallel(arm->setState(Positions::L3FrontConfirm, Heading::Front),
                    ...
                    {Positions::L4Front, Positions::FrontConfirm, [this]() {
                        return grabber->isCoralIn() && driver->RightBumper().Get()
                                ...
                                && alignManager->getHeading() == Heading::Front;
                    }, frc2::cmd::Parallel(arm->setState(Positions::L4FrontConfirm, Heading::Front),
                    ...
                    }, frc2::cmd::Sequence(grabber->setState(Positions::NetConfirm),
                            arm->setState(Positions::NetConfirm), elevator->setState(Positions::NetConfirm),
                            intake->setState(Positions::NetConfirm), climber->setState(Positions::NetConfirm))}, {
                    ...
                    {Positions::ProcessorPosition, Positions::ProcessorConfirm, [this]() {
                        return grabber->isAlgaeIn() && driver->RightBumper().Get();
                    }, frc2::cmd::Sequence(grabber->setState(Positions::ProcessorConfirm),
                            intake->setState(Positions::ProcessorConfirm), arm->setState(Positions::ProcessorConfirm),
                            elevator->setState(Positions::ProcessorConfirm),
                            climber->setState(Positions::ProcessorConfirm))}, {Positions::ProcessorPosition,
                            Positions::EndPosition, [this]() {
                                return console->Button(4).Get() || oprtr->Back().Get();
                            }, frc2::cmd::Sequence(arm->setState(Positions::EndPosition),
                                    elevator->setState(Positions::EndPosition),
                    ...
                    {Positions::NetConfirm, Positions::SustainedPosition, [this]() {
                        return !grabber->isAlgaeIn();
                            ...
                            arm->setState(Positions::SustainedPosition), intake->setState(Positions::SustainedPosition),
                            grabber->setState(Positions::SustainedPosition),
                            climber->setState(Positions::SustainedPosition))}, {Positions::NetConfirm,
                            Positions::CoralHold, [this]() {
                    ...
                    {Positions::ProcessorConfirm, Positions::SustainedPosition, [this]() {
                        return !grabber->isAlgaeIn();
                            ...
                            arm->setState(Positions::SustainedPosition), intake->setState(Positions::SustainedPosition),
                            grabber->setState(Positions::SustainedPosition),
                            climber->setState(Positions::SustainedPosition))}, {Positions::ProcessorConfirm,
                            Positions::CoralHold, [this]() {
                                return !grabber->isAlgaeIn() && intake->isCoralIn();
                            }, frc2::cmd::Sequence(intake->setState(Positions::CoralHold),
                                    arm->setState(Positions::CoralHold), elevator->setState(Positions::CoralHold),
