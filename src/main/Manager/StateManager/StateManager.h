...
private:
    ...
    {Positions::L1Position, Positions::L1Confirm, [this]() {
        ...
        return false /*Boton Respectivo*/&& !grabber->isAlgaeIn() && intake->isCoralIn();
    ...
    {Positions::L2Front, Positions::L2FrontConfirm, [this]() {
        return grabber->isCoralIn() && false; /*suma de dos botones*/
    }}, {Positions::L3Front, Positions::L3FrontConfirm, [this]() {
        return grabber->isCoralIn() && false; /*suma de dos botones*/
    }}, {Positions::L4Front, Positions::L4FrontConfirm, [this]() {
        return grabber->isCoralIn() && false; /*suma de dos botones*/
    }},

    {Positions::L2Back, Positions::L2BackConfirm, [this]() {
        return grabber->isCoralIn() && false; /*suma de dos botones*/
    }}, {Positions::L3Back, Positions::L3BackConfirm, [this]() {
        return grabber->isCoralIn() && false; /*suma de dos botones*/
    }}, {Positions::L4Back, Positions::L4BackConfirm, [this]() {
        return grabber->isCoralIn() && false; /*suma de dos botones*/
    }},
    ...
    {Positions::L2FrontConfirm, Positions::SustainedPosition, [this]() {
        return !grabber->isCoralIn();
    }}, {Positions::L3FrontConfirm, Positions::SustainedPosition, [this]() {
        return !grabber->isCoralIn();
    }}, {Positions::L4FrontConfirm, Positions::SustainedPosition, [this]() {
        return !grabber->isCoralIn();
    }},

    {Positions::L2BackConfirm, Positions::SustainedPosition, [this]() {
        return !grabber->isCoralIn();
    }}, {Positions::L3BackConfirm, Positions::SustainedPosition, [this]() {
        return !grabber->isCoralIn();
    }}, {Positions::L4BackConfirm, Positions::SustainedPosition, [this]() {
        return !grabber->isCoralIn();
    }},
    ...
    {Positions::EndPosition, Positions::SustainedPosition, [this]() {
        return false; /*Boton especifico*/
    }}, {Positions::EndPosition, Positions::CoralHold, [this]() {
        return false /*Boton especifico*/&& grabber->isCoralIn();
    }}
